...
{
    PR_DEBUG("__ai_audio_input_inform_handle event: %d", event);
...
OPERATE_RET ai_audio_init(AI_AUDIO_CONFIG_T *cfg)
{
    ...
    PR_DEBUG("ai audio work mode: %d, input get valid data method: %d", sg_ai_audio.work_mode,
             input_cfg.get_valid_data_method);
