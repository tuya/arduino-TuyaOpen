...
extern const char media_src_key_dialogue_zh[8253];
extern const char media_src_long_press_dialogue_zh[8901];
...
extern const char media_src_random_dialogue_zh[7605];
extern const char media_src_wake_dialogue_zh[9333];
