...
static __attribute__((unused)) UI_EMOJI_LIST_T sg_emo_list[EMO_ICON_MAX_NUM] = {
    {"NEUTRAL", (char *)"😶"},  {"SAD", (char *)"😔"},      {"ANGRY", (char *)"😠"}, {"SURPRISE", (char *)"😯"},
    {"CONFUSED", (char *)"😏"}, {"THINKING", (char *)"🤔"}, {"HAPPY", (char *)"🙂"},
};
...
static const char *__ui_wifi_icon_get(UI_WIFI_STATUS_E status)
{
    const char *wifi_icon = FONT_AWESOME_WIFI_OFF;
...
static void __app_display_msg_handle(DISPLAY_MSG_T *msg_data)
{
    ...
    case TY_DISPLAY_TP_NETWORK: {
        ...
        const char *wifi_icon = __ui_wifi_icon_get(status);
